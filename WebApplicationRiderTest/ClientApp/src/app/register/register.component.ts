...
export class RegisterComponent implements OnInit {
  ...
  constructor (private countryService: CountryService, private router: Router, private apiService: ApiService, private messageService: MessageService) { }
  ...
  selectedGender: GenderModel = new GenderModel();
  ...
  ngOnInit() {
    ...
    this.selectedCountry.name = 'China';
